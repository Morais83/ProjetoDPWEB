                    ...
                    <div class="tab-content" id="level-tabsContent">
                        ...
                        <div class="tab-pane fade show active" id="basic" role="tabpanel" aria-labelledby="basic-tab" tabindex="0">
                            <div class="card border-0 p-4 mb-3">
                                ...
                                <div class="row g-3">
                                    <div class="col-sm-6">
                                        ...
                                        <ul class="list-unstyled small mb-0">
                                            <li><span class="phrase-example">Hallo!</span> – Olá!</li>
                                            <li><span class="phrase-example">Guten Morgen!</span> – Bom dia!</li>
                                            <li><span class="phrase-example">Gute Nacht!</span> – Boa noite!</li>
                                        </ul>
                                    </div>
                                    <div class="col-sm-6">
                                        <h3 class="h6 text-uppercase text-muted mb-2">Apresentações</h3>
                                        <ul class="list-unstyled small mb-0">
                                            <li><span class="phrase-example">Ich heiße João.</span> – Chamo-me João.</li>
                                            <li><span class="phrase-example">Ich komme aus Portugal.</span> – Venho de Portugal.</li>
                                            <li><span class="phrase-example">Freut mich, dich kennenzulernen.</span> – Prazer em conhecer-te.</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-wrap gap-2 mb-3">
                                    <span class="badge text-bg-light">Zahlen · números</span>
                                    <span class="badge text-bg-light">Wochentage · dias da semana</span>
                                    <span class="badge text-bg-light">Essen · comida</span>
                                    <span class="badge text-bg-light">Familie · família</span>
                                </div>
                            ...
                            <div class="card border-0 p-4 mb-3">
                                ...
                                <div class="row g-3">
                                    <div class="col-sm-6">
                                        ...
                                        <ul class="list-unstyled small mb-0">
                                            <li><span class="phrase-example">Ich wache um 7 Uhr auf.</span> – Acordo às 7h.</li>
                                            <li><span class="phrase-example">Ich fahre mit dem Bus zur Arbeit.</span> – Vou para o trabalho de autocarro.</li>
                                            <li><span class="phrase-example">Ich lerne jeden Tag Deutsch.</span> – Estudo Alemão todos os dias.</li>
                                        </ul>
                                    </div>
                                    <div class="col-sm-6">
                                        <h3 class="h6 text-uppercase text-muted mb-2">Fazer perguntas</h3>
                                        <ul class="list-unstyled small mb-0">
                                            <li><span class="phrase-example">Was machst du beruflich?</span> – O que fazes (profissão)?</li>
                                            <li><span class="phrase-example">Wo wohnst du?</span> – Onde vives?</li>
                                            <li><span class="phrase-example">Wie war dein Tag?</span> – Como foi o teu dia?</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-wrap gap-2 mb-3">
                                    <span class="badge text-bg-light">Präsens (tempo presente)</span>
                                    <span class="badge text-bg-light">Präteritum / Perfekt (passado)</span>
                                    <span class="badge text-bg-light">Es gibt / Es gibt nicht</span>
                        ...
                        <div class="tab-pane fade" id="advanced" role="tabpanel" aria-labelledby="advanced-tab" tabindex="0">
                            <div class="card border-0 p-4 mb-3">
                                ...
                                <p class="text-secondary mb-3">
                                    Neste nível o objetivo é deixar o alemão mais fluido e natural,
                                ...
                                <div class="row g-3">
                                    <div class="col-sm-6">
                                        ...
                                        <ul class="list-unstyled small mb-0">
                                            <li><span class="phrase-example">Um ehrlich zu sein...</span> – Para ser sincero...</li>
                                            <li><span class="phrase-example">Es kommt darauf an.</span> – Depende.</li>
                                            <li><span class="phrase-example">Ich freue mich darauf.</span> – Estou ansioso por isso.</li>
                                        </ul>
                                    </div>
                                    <div class="col-sm-6">
                                        <h3 class="h6 text-uppercase text-muted mb-2">Ligar ideias</h3>
                                        <ul class="list-unstyled small mb-0">
                                            <li><span class="phrase-example">Allerdings,</span> – No entanto,</li>
                                            <li><span class="phrase-example">Auf der anderen Seite,</span> – Por outro lado,</li>
                                            <li><span class="phrase-example">Meiner Meinung nach,</span> – Na minha opinião,</li>
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div class="d-flex flex-wrap gap-2 mb-3">
                                    <span class="badge text-bg-light">Listening com séries / vídeos em alemão</span>
                                ...
                                <p class="small text-muted mb-0">
                                    Dica: tenta explicar uma opinião tua em alemão (sobre um filme, jogo,
                                    escola, etc.) usando conectores como <em>allerdings</em>, <em>weil</em>,
                                    <em>obwohl</em>.
                                </p>
                            </div>
                        </div>
                ...
                <div class="col-md-4">
                    <div class="card p-3 h-100">
                        ...
                        <p class="small text-secondary mb-0">
                            ...
                            <span class="phrase-example">Ich fahre mit dem Bus zur Schule.</span>
