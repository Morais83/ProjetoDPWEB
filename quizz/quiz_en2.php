...
<body>
    ...
    <main class="quiz container my-3">
        <div class="card p-3 mx-auto" style="max-width:760px;border-color:#ccc">
            <h1 class="fs-4 mb-2">QUIZZ 2 – Inglês (A2)</h1>
            ...
            <fieldset data-q="2" data-correct="c">
                <div class="q-title mt-3">2) Completar a frase: <em>We ___ football every weekend.</em></div>
                <div class="vstack gap-1 mt-1">
                <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2"><input type="radio" name="q2" value="a">a) playing</label>
                <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2"><input type="radio" name="q2" value="b">b) plays</label>
                <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2"><input type="radio" name="q2" value="c">c) play</label>
                <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2"><input type="radio" name="q2" value="d">d) played</label>
                </div>
                <div class="feedback text-body-tertiary" hidden></div>
            </fieldset>

            <fieldset data-q="3" data-correct="a">
                <div class="q-title mt-3">3) “What time is it?” significa:</div>
                <div class="vstack gap-1 mt-1">
            ...
            <fieldset data-q="4" data-answer-text="i like coffee">
                <div class="q-title mt-3">4) Traduzir para inglês: <em>“Eu gosto de café.”</em></div>
                <input type="text" name="q4" class="form-control mt-1" placeholder="Escreve aqui a tradução">
                <div class="feedback text-body-tertiary" hidden></div>
            </fieldset>

            <fieldset data-q="5" data-correct="b">
                <div class="q-title mt-3">5) Completar a frase: <em>They ___ very happy today.</em></div>
                <div class="vstack gap-1 mt-1">
                <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2"><input type="radio" name="q5" value="a">a) am</label>
                <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2"><input type="radio" name="q5" value="b">b) are</label>
                <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2"><input type="radio" name="q5" value="c">c) is</label>
            ...
            <div class="next-quiz" id="nextQuiz" hidden>
                ...
                <a href="quiz_en3.php" class="btn btn-outline-dark">Ir para o próximo quizz</a>
            </div>
            </form>
        </div>
    </main>
    ...
    <script>
        ...
        form.addEventListener('submit', e => {
            ...
            if (ok) {
                ...
                const pretty = fs.dataset.q === '1' ? 'Eu vou ao supermercado.' : 'I like coffee.';
                show(fs, good, pretty);
            }
            if (good) score++;
            });
