...
<body>
  ...
  <main class="quiz container my-3">
    <div class="card p-3 mx-auto" style="max-width:760px;border-color:#ccc">
      <h1 class="fs-4 mb-2">QUIZZ 3 – Francês (B1)</h1>
      ...
      <form id="quiz" novalidate>
        <fieldset data-q="1" data-correct="a">
          <div class="q-title">1) Escolher a tradução correta:<br><em>“Elle a déjà fini ses devoirs.”</em></div>
          <div class="vstack gap-1 mt-1">
            <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2">
              <input type="radio" name="q1" value="a">
              a) Ela já terminou os trabalhos de casa.
            </label>
            <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2">
              <input type="radio" name="q1" value="b">
              b) Ela vai terminar os trabalhos.
            </label>
            <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2">
              <input type="radio" name="q1" value="c">
              c) Ela ainda não terminou.
            </label>
            <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2">
              <input type="radio" name="q1" value="d">
              d) Ela está a fazer os trabalhos.
            </label>
          </div>
        ...
        <fieldset data-q="2" data-correct="a">
          <div class="q-title mt-3">2) Completar a frase: <em>S’il ___ demain, nous resterons à la maison.</em></div>
          <div class="vstack gap-1 mt-1">
            <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2">
        ...
        <fieldset data-q="3" data-answer-text="Je ne suis jamais allé à Paris.">
          <div class="q-title mt-3">3) Traduzir para francês: <em>“Eu nunca estive em Paris.”</em></div>
        ...
        <fieldset data-q="4" data-correct="a">
          <div class="q-title mt-3">4) “Il cherche ses clés.” significa:</div>
          <div class="vstack gap-1 mt-1">
            <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2">
              <input type="radio" name="q4" value="a">
              a) Ele está à procura das chaves.
            </label>
            <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2">
              <input type="radio" name="q4" value="b">
              b) Ele encontrou as chaves.
            </label>
            <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2">
              <input type="radio" name="q4" value="c">
              c) Ele perdeu as chaves.
            </label>
            <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2">
              <input type="radio" name="q4" value="d">
              d) Ele olha para as chaves.
            </label>
          </div>
          <div class="feedback text-body-tertiary" hidden></div>
        </fieldset>
        ...
        <fieldset data-q="5" data-correct="a">
          <div class="q-title mt-3">5) Completar a frase: <em>Je ___ mon téléphone si je ne me dépêche pas.</em></div>
          <div class="vstack gap-1 mt-1">
            <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2">
        ...
        <div class="next-quiz" id="nextQuiz" hidden>
          <p class="mb-2 fw-bold">Conseguiste!<br>Queres continuar a praticar?</p>
          <a href="quiz_fr4.php" class="btn btn-outline-dark">Voltar à página de francês</a>
        </div>
      </form>
    </div>
  </main>
