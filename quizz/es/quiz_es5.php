...
<body>
  ...
  <main class="quiz container my-3">
    <div class="card p-3 mx-auto" style="max-width:760px;border-color:#ccc">
      <h1 class="fs-4 mb-2">QUIZZ 5 – Espanhol (C1)</h1>
      ...
      <form id="quiz" novalidate>
        <fieldset data-q="1" data-correct="a">
          <div class="q-title">1) Escolher a tradução correta:<br><em>“A pesar de estar cansada, terminó la maratón.”</em></div>
          <div class="vstack gap-1 mt-1">
            ...
            <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2">
              <input type="radio" name="q1" value="b">b) Ela estava cansada porque terminou.
            </label>
            <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2">
              <input type="radio" name="q1" value="c">c) Ela não terminou.
            </label>
            <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2">
              <input type="radio" name="q1" value="d">d) Ela começou a maratona.
            </label>
          </div>
        ...
        <fieldset data-q="2" data-correct="a">
          <div class="q-title mt-3">2) Completar a frase: <em>Si hubiera sabido de la fiesta, ___ ido.</em></div>
          <div class="vstack gap-1 mt-1">
            <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2">
              <input type="radio" name="q2" value="a">a) habría
            </label>
            <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2">
              <input type="radio" name="q2" value="b">b) hubiera
            </label>
            <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2">
              <input type="radio" name="q2" value="c">c) fui
            </label>
            <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2">
              <input type="radio" name="q2" value="d">d) habrá
            </label>
          </div>
          <div class="feedback text-body-tertiary" hidden></div>
        </fieldset>

        <fieldset data-q="3" data-answer-text="Se comportaron como si fueran los dueños del lugar.">
          <div class="q-title mt-3">3) Traduzir para espanhol: <em>“Eles comportaram-se como se fossem os donos do lugar.”</em></div>
        ...
        <fieldset data-q="4" data-correct="a">
          <div class="q-title mt-3">4) Escolher a tradução correta:<br><em>“Ya es hora de que estudies para el examen.”</em></div>
          <div class="vstack gap-1 mt-1">
            <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2">
              <input type="radio" name="q4" value="a">a) Já está mais que na hora de estudares para o exame.
            </label>
            <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2">
              <input type="radio" name="q4" value="b">b) É tarde demais para o exame.
            </label>
            <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2">
              <input type="radio" name="q4" value="c">c) Ainda é cedo.
            </label>
            <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2">
        ...
        <fieldset data-q="5" data-correct="a">
          <div class="q-title mt-3">5) Completar a frase: <em>No solo ___ el projeto, sino que también lo presentó perfectamente.</em></div>
          <div class="vstack gap-1 mt-1">
            <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2">
              <input type="radio" name="q5" value="a">a) terminó
            </label>
            <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2">
              <input type="radio" name="q5" value="b">b) terminó ella
            </label>
            <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2">
              <input type="radio" name="q5" value="c">c) ella terminó
            </label>
            <label class="opt d-flex align-items-center gap-2 border rounded-1 p-2">
              <input type="radio" name="q5" value="d">d) ha terminado ella
            </label>
          </div>
          <div class="feedback text-body-tertiary" hidden></div>
        </fieldset>
        ...
        <div class="next-quiz" id="nextQuiz" hidden>
          <p class="mb-2 fw-bold">Fantástico! Completaste todos os desafios de Espanhol.<br>Está na hora de embarcar numa nova aventura linguística!</p>
